...
var StepFunctions = (() => {
  ...
  // content/multinumbers/functions.ts
  ...
  var BrowserInstance = class {
    constructor() {
      ...
      this.themeOverride = "";
      this.darkQuery = (_a = window.matchMedia) === null || _a === void 0 ? void 0 : _a.call(window, "(prefers-color-scheme: dark)");
    ...
    setStorage(key, value) {
      ...
      const storage = safeToJSON(((_a = this.localStorage) === null || _a === void 0 ? void 0 : _a.getItem(STORAGE_KEY)) || void 0);
      let path = storage;
    ...
    getStorage(key) {
      var _a;
      let path = safeToJSON(((_a = this.localStorage) === null || _a === void 0 ? void 0 : _a.getItem(STORAGE_KEY)) || void 0);
      if (!key)
        return path;
      const keys = (key || "").split(".");
    ...
    deleteStorage(key) {
      ...
      if (key) {
        ...
        (_a = this.localStorage) === null || _a === void 0 ? void 0 : _a.setItem(STORAGE_KEY, "");
      }
    }
    getActiveInput() {
    ...
    setup(options = {}) {
      ...
      if (options.history) {
        window.addEventListener("popstate", (e) => __awaiter(this, void 0, void 0, function* () {
          var _a;
          if (!isReady || !((_a = e.state) === null || _a === void 0 ? void 0 : _a.path))
            return;
  ...
  var Gameplay = class extends CustomElementView {
    ...
    ready() {
      ...
      for (let i = 0; i < this.target[1]; ++i)
        $N("div", {class: "dot"}, this.$dots);
    }
    setup($step) {
    ...
    score(correct = false) {
      var _a;
      (_a = this.$currentSlide) == null ? void 0 : _a.addClass("done");
    ...
    makeSlide(initial = false) {
      ...
      if (!initial)
        $slide.animate({transform: ["translateX(100%)", "none"]}, 400);
  ...
  var Solved = class extends CustomElementView {
    ...
    enter() {
      ...
      const hint = ((_a = $step == null ? void 0 : $step.addHint("correct")) == null ? void 0 : _a.text) || "Well done!";
  ...
  function divisibilityGame($step) {
    ...
    $gameplay.setSlideGenerator(($el, success, error) => {
      let numberArr = [567700, 875490, 2356e3, 4100655, 23540333, 23481777, 3450827, 3600890, 450827];
      const n1 = random.find(numberArr);
      const n2 = random.find(numberArr);
      let answer;
      if (n1 > n2) {
        answer = 0;
      } else if (n1 < n2) {
