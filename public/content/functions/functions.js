...
var StepFunctions = (() => {
  ...
  var SVGParentView = class extends SVGBaseView {
    ...
    pngImage(width2, height2, viewBox) {
      return __awaiter(this, void 0, void 0, function* () {
    ...
    downloadImage(fileName, width2, height2, viewBox) {
      ...
      this.pngImage(width2, height2, viewBox).then((href) => {
        if (windowRef)
  ...
  function create3D(_0, _1, _2) {
    return __async(this, arguments, function* ($el, fov, width2, height2 = width2, camera) {
      const $canvas = $N("canvas", {width: width2, height: height2, style: "max-width: 100%"}, $el);
  ...
  var ConicSection = class extends CustomElementView {
    ready() {
      return __async(this, null, function* () {
        ...
        scene.add(plane);
        const tubeMaterial = new THREE.MeshLambertMaterial({color: 13438566, clippingPlanes: [right]});
  ...
  // content/functions/components/pi-scroll.ts
  var ROW_HEIGHT = 30;
  var NUM_ELS = 100;
  var VISIBLE_ELS = 10;
  ...
  // content/functions/components/ellipse.ts
  var Rope = class {
