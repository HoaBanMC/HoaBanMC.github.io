...
(() => {
    ...
    cut(line) {
      ...
      for (const e of this.edges) {
        ...
        if (side1 && side2 && side1 !== side2) {
          const int2 = intersections(e, line)[0];
          edges.push(new Segment(e.p1, int2));
          const e2 = new Segment(int2, e.p2);
          e2.flag = side2;
          edges.push(e2);
          edgesOnLine.push(e2);
        } else {
  ...
  var SVGParentView = class extends SVGBaseView {
    ...
    pngImage(width2, height, viewBox) {
      return __awaiter(this, void 0, void 0, function* () {
    ...
    downloadImage(fileName, width2, height, viewBox) {
      ...
      this.pngImage(width2, height, viewBox).then((href) => {
        if (windowRef)
  ...
  var Narration = class {
        ...
        p.on("end", () => {
          ...
          if (this.paragraphs[i + 1]) {
            ...
            if ($next && $next.isShown)
              (_a3 = $next.narration) == null ? void 0 : _a3.play();
          }
        });
      }
    }
    play() {
      ...
      if (this.audio.isPlaying || !continuePlaying)
        return;
      (_a3 = this.paragraphs[0]) == null ? void 0 : _a3.play();
    }
  };
  ...
  function showAlert(key, duration = 4e3) {
    var _a3;
    return (_a3 = $alerts.get(key)) == null ? void 0 : _a3.open(duration);
  }
  ...
  var Blank = class extends CustomElementView {
    ...
    setup($step, goal, userData) {
      ...
      this.goal = goal;
      this.$step = $step;
      if ((_a3 = userData == null ? void 0 : userData.scores) == null ? void 0 : _a3.includes(goal))
        this.solve(true);
      this.one("valid", () => {
    ...
    ready() {
      ...
      hover(this, {
        enter: () => {
          ...
          this.$popup.css("max-width", !spaceOnLeft && !spaceOnRight ? `${maxWidth}px` : "none");
        },
        exit: () => {
          this.removeClass("on");
        },
  ...
  var FreeText = class extends CustomElementView {
    setup($step, id, userData) {
      ...
      let text = ((_a3 = userData == null ? void 0 : userData.data) == null ? void 0 : _a3[DATA_KEY]) || "";
      if (text)
        $text.html = text;
  ...
  var Picker = class extends CustomElementView {
    ...
    setup($step, id, userData) {
      ...
      const scores = ((_a3 = userData == null ? void 0 : userData.scores) == null ? void 0 : _a3.filter((x) => x.startsWith("picker-"))) || [];
  ...
  // node_modules/@mathigon/studio/frontend/components/share/share.pug
  var share_default = '<a class="btn twitter" title="Twitter" href="https://twitter.com/intent/tweet?url=${url}&amp;text=${title}&amp;via=undefined" target="_blank" rel="noopener"><x-icon name="twitter" size="36"></x-icon></a><a class="btn facebook" title="Facebook" href="https://www.facebook.com/dialog/share?app_id=undefined&amp;display=page&amp;href=${url}" target="_blank" rel="noopener"><x-icon name="facebook" size="36"></x-icon></a><button class="btn" title="Copy to Clipboard" :show="canCopy" @click="copy()"><x-icon name="link" size="36"></x-icon></button><x-alert class="success" key="clipboard"><x-icon name="check" size="24"></x-icon> URL copied to clipboard!</x-alert>';

  // node_modules/@mathigon/studio/frontend/components/share/share.ts
  var ShareRow = class extends CustomElementView {
    ready() {
      ...
      for (const $s of this.$$("a.btn")) {
        $s.on("click", (e) => {
          window == null ? void 0 : window.ga("send", "event", "Share", $s.attr("title"));
          e.preventDefault();
    ...
    copyUrl() {
      return __async(this, null, function* () {
        ...
        yield window.navigator.clipboard.writeText(url);
        if (navigator.canShare) {
          navigator.share({title: this.attr("title"), url});
        }
        showAlert("clipboard");
      });
    }
  ...
  ShareRow = __decorate([
    register("x-share", {template: share_default})
  ], ShareRow);

  // node_modules/@mathigon/studio/frontend/components/draggable/draggable.ts
  var Draggable = class extends EventTarget {
    ...
    addTarget($target) {
      ...
      (_a3 = this.options.$targets) == null ? void 0 : _a3.push($target);
    }
    removeTarget($target) {
      var _a3, _b;
      this.options.$targets = (_a3 = this.options.$targets) == null ? void 0 : _a3.filter(($el) => $el != $target);
    ...
    updateBounds() {
      ...
      if (oldBounds) {
        this.setPosition(this.position.x * this.bounds.dx / oldBounds.dx || 0, this.position.y * this.bounds.dy / oldBounds.dy || 0);
      }
    }
    setPosition(x, y) {
      var _a3;
      ...
      if (this.bounds)
        p = p.clamp(this.bounds, (_a3 = this.options.margin) != null ? _a3 : 0);
  ...
  var Slideshow = class extends CustomElementView {
    ...
    setup($step, _id, userData) {
      var _a3;
      const posn = (_a3 = userData == null ? void 0 : userData.scores) == null ? void 0 : _a3.filter((s) => s.startsWith("slide-")).length;
  ...
  var CourseSidebar = class extends CustomElementView {
    ready() {
      var _a3, _b;
      (_a3 = $(".sidebar-toggle")) == null ? void 0 : _a3.on("click", () => this.addClass("open"));
  ...
  var Step = class extends CustomElementView {
    ...
    ready() {
      ...
      this.userData = (_c = (_b = (_a3 = this.$course) == null ? void 0 : _a3.userData) == null ? void 0 : _b.steps) == null ? void 0 : _c[this.id];
    ...
    show() {
      ...
      if (this.isShown)
        return;
      this.isShown = true;
      (_a3 = StepFunctions == null ? void 0 : StepFunctions[toCamelCase(this.id)]) == null ? void 0 : _a3.call(StepFunctions, this);
    ...
    storeData(key, value) {
      var _a3;
      (_a3 = this.$course) == null ? void 0 : _a3.saveProgress({steps: {[this.id]: {data: {[key]: value}}}});
    }
    ...
    addHint(text, options = {}) {
      ...
      if (!((_a3 = this.$course) == null ? void 0 : _a3.isReady))
        return {text};
      if (this.isInViewport) {
        ...
        this.one("enterViewport", () => {
          var _a4;
          return (_a4 = this.$course.$tutor) == null ? void 0 : _a4.showHint(text, options);
        });
  ...
  // node_modules/@mathigon/hilbert/dist/hilbert.esm.js
  ...
  var ExprIdentifier = class extends ExprElement {
    ...
    interval(vars = {}) {
      var _a3;
      const x = (_a3 = vars[this.i]) !== null && _a3 !== void 0 ? _a3 : CONSTANTS[this.i];
      if (Array.isArray(x))
        return x;
      if (typeof x === "number")
        return [x, x];
  ...
  var interval = {
    add: (a2, b2) => int(a2[0] + b2[0], a2[1] + b2[1]),
    sub: (a2, b2) => b2 !== void 0 ? int(a2[0] - b2[1], a2[1] - b2[0]) : int(-a2[1], -a2[0]),
    mul: (a2, b2) => range(a2[0] * b2[0], a2[0] * b2[1], a2[1] * b2[0], a2[1] * b2[1]),
  ...
  var ExprFunction = class extends ExprElement {
    ...
    substitute(vars = {}) {
      return new ExprFunction(this.fn, this.args.map((a2) => a2.substitute(vars)));
    }
    collapse() {
      if (this.fn === "(")
        return this.args[0].collapse();
      return new ExprFunction(this.fn, this.args.map((a2) => a2.collapse()));
    }
    get simplified() {
      return this;
    }
  ...
  (function(TokenType2) {
    ...
    TokenType2[TokenType2["STR"] = 2] = "STR";
    TokenType2[TokenType2["NUM"] = 3] = "NUM";
    TokenType2[TokenType2["VAR"] = 4] = "VAR";
    TokenType2[TokenType2["OP"] = 5] = "OP";
  })(TokenType || (TokenType = {}));
  ...
  function tokenize(str) {
    ...
    for (const s of str) {
      if (s === '"') {
        const newType = type === TokenType.STR ? TokenType.UNKNOWN : TokenType.STR;
      ...
      const sType = s.match(/[0-9.]/) ? TokenType.NUM : IDENTIFIER_SYMBOLS.includes(s) ? TokenType.VAR : OPERATOR_SYMBOLS.includes(s) ? TokenType.OP : s.match(/\s/) ? TokenType.SPACE : TokenType.UNKNOWN;
      if (!sType)
        throw ExprError.invalidCharacter(s);
      if (!type || type === TokenType.NUM && sType !== TokenType.NUM || type === TokenType.VAR && sType !== TokenType.VAR && sType !== TokenType.NUM || type === TokenType.OP && !(buffer + s in SPECIAL_OPERATORS) || type === TokenType.SPACE && sType !== TokenType.SPACE) {
        const token2 = createToken(buffer, type);
        if (token2)
          tokens.push(token2);
        buffer = "";
  ...
  var correctImg = loop(random.shuffle([
    "happy",
    "spongebob",
    "sloth",
    "party",
  ...
  var incorrectImg = loop(random.shuffle([
    "minions",
    "panther",
    "dog",
    "snape",
  ...
  var Tutor = class extends CustomElementView {
    ...
    ready() {
      ...
      this.correct = loop(random.shuffle(this.hints.correct || []));
      this.incorrect = loop(random.shuffle(this.hints.incorrect || []));
      ...
      if (this.$course && ((_a3 = this.$course.userData) == null ? void 0 : _a3.messages)) {
        for (const m of this.$course.userData.messages) {
          this.$chatBody.append(createMsgElement(m.content, m.kind || "hint", {visible: true}));
        }
      }
